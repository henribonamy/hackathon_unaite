...
user_query: str = (
    "I want to test locally recent open-source project of image generation. For example look at https://github.com/HaozheZhao/UltraEdit"
)
...
installation_steps: str = webScraperAgent.get_installation_steps(
